...
/// <summary>
/// Es una tabla transaccional donde se registran los traspasos por unificación familiar, no llegan al proceso de asignación de NUCUF, su fuente de datos son las vistas de traspasos publicadas por UNIPAGO.
/// </summary>
public partial class TraspasosNucufMaster
{
    /// <summary>
    ...
    /// Es único número de documento de identificación oficial (Cedula, residencia, Pasaporte, etc.) de cada persona registrada en el padrón de ciudadanos de la TSS.
    /// </summary>
    public string CedulaDependiente { get; set; } = null!;
