...
/// </summary>
public partial class AccidentesTransitoArsTran
{
    /// <summary>
    ...
    public virtual AccidentesColisionesTipoCatum ColisionTipoNumeroNavigation { get; set; } = null!;

    public virtual AccidentesDiagnosticosCieCatum DiagnosticoInicialCodigoNavigation { get; set; } = null!;

    public virtual ComunesMunicipiosCatum MunicipioNumeroNavigation { get; set; } = null!;

    public virtual AccidentesOrigenesCatum OrigenNumeroNavigation { get; set; } = null!;

    public virtual AccidentesPosicionesLesionadosCatum PosicionLesionadoNumeroNavigation { get; set; } = null!;

    public virtual SeguimientosLotesTran Seguimiento { get; set; } = null!;

    public virtual AccidentesVehiculosTipoCatum VehiculoTipoNumeroNavigation { get; set; } = null!;
}
