...
public partial class PromotoresPreguntasRespuestasCatum
{
    /// <summary>
    ...
    public virtual PromotoresPreguntasCatum PreguntaNumeroNavigation { get; set; } = null!;

    public virtual ICollection<PromotoresPreguntasRespuestasHistorico> PromotoresPreguntasRespuestasHistoricos { get; set; } = new List<PromotoresPreguntasRespuestasHistorico>();
}
