...
/// <summary>
/// Es una tabla transaccional donde se registran los datos para el seguimiento por actividades (servicios de salud)  del PYP, calculados a partir de los reportes del esquema 40 que realizan las ARS,  su fuente de datos son los sistemas  de la SISALRIL.
/// </summary>
public partial class PypSeguimientosActividadesTran
{
    /// <summary>
    ...
    /// Representa el peso del valor de la actividad (Cobertura) para un programa de salud (Subgrupo).
    /// </summary>
    public int ValorCumplimientoPonderado { get; set; }

    /// <summary>
    /// Representa el peso del valor de la actividad (Cobertura) para un programa de salud (Subgrupo).
    /// </summary>
    public decimal PorcentajeCumplimientoPonderado { get; set; }
