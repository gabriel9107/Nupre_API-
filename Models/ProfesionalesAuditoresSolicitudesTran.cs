...
public partial class ProfesionalesAuditoresSolicitudesTran
{
    ...
    public virtual ICollection<ProfesionalesAuditoresSolicitudesEmpresasTran> ProfesionalesAuditoresSolicitudesEmpresasTrans { get; set; } = new List<ProfesionalesAuditoresSolicitudesEmpresasTran>();
    ...
    public virtual ICollection<ProfesionalesAuditoresSolicitudesHistorico> ProfesionalesAuditoresSolicitudesHistoricos { get; set; } = new List<ProfesionalesAuditoresSolicitudesHistorico>();

    public virtual ICollection<ProfesionalesAuditoresSolicitudesRequerimientosTran> ProfesionalesAuditoresSolicitudesRequerimientosTrans { get; set; } = new List<ProfesionalesAuditoresSolicitudesRequerimientosTran>();
