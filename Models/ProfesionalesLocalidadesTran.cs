...
public partial class ProfesionalesLocalidadesTran
{
    /// <summary>
    ...
    public string ProfesionalLocalidadDetalle { get; set; } = null!;

    public string ProfesionalLocalidadTelefono1 { get; set; } = null!;

    public string ProfesionalLocalidadTelefono2 { get; set; } = null!;

    public string ProfesionalLocalidadPrestadoraNombre { get; set; } = null!;
