...
public partial class ProfesionalesMaster
{
    ...
    public virtual ICollection<ProfesionalesEmpresasTran> ProfesionalesEmpresasTrans { get; set; } = new List<ProfesionalesEmpresasTran>();
    ...
    public virtual ICollection<ProfesionalesExamenesTran> ProfesionalesExamenesTrans { get; set; } = new List<ProfesionalesExamenesTran>();
    ...
    public virtual ICollection<ProfesionalesHistorico> ProfesionalesHistoricos { get; set; } = new List<ProfesionalesHistorico>();

    public virtual ICollection<ProfesionalesLocalidadesTran> ProfesionalesLocalidadesTrans { get; set; } = new List<ProfesionalesLocalidadesTran>();
