...
/// <summary>
/// Es una tabla transaccional donde se registran las prestaciones de los servicios de salud de Previsión y Promoción de la Salud (PYP) reportados pro las ARS,  su fuente de datos es el esquema 40 procesado por el Robot Simon.
/// </summary>
public partial class PypServiciosTran
{
    /// <summary>
