...
public partial class ProfesionalesRequerimientosTran
{
    ...
    public virtual ICollection<ProfesionalesRequerimientosHistorico> ProfesionalesRequerimientosHistoricos { get; set; } = new List<ProfesionalesRequerimientosHistorico>();
