...
/// <summary>
/// Es una tabla transaccional donde se registran los un requerimiento (Documento, Identificación, otros), presentado por una entidad para un proceso de acreditación, su fuente de datos son los sistemas internos de la SISALRIL.
/// </summary>
public partial class AcreditacionesEntidadesRequerimientosTran
{
    /// <summary>
