...
public partial class SeguimientosEsquemas66Tran
{
    /// <summary>
    ...
    /// </summary>
    public string CedulaBeneficiario { get; set; } = null!;

    /// <summary>
    /// 1 = Conyugue, 2 =Tutor, 3 = Hijo Mayor.
    /// </summary>
    public string TipoBeneficiario { get; set; } = null!;

    /// <summary>
    /// Reportar la cantidad de beneficiarios.
    /// </summary>
    public string CantidadBeneficiarios { get; set; } = null!;
