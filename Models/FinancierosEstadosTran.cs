...
/// </summary>
public partial class FinancierosEstadosTran
{
    /// <summary>
    ...
    public virtual FinancierosEstadosCuentasCatum Estado { get; set; } = null!;

    public virtual FinancierosPlanesCatum PlanCuentaNumeroNavigation { get; set; } = null!;
}
