...
public partial class AuditoresRequerimientosEstadosCatum
{
    ...
    public virtual ICollection<AuditoresRequerimientosTran> AuditoresRequerimientosTrans { get; set; } = new List<AuditoresRequerimientosTran>();
}
