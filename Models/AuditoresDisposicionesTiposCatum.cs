...
public partial class AuditoresDisposicionesTiposCatum
{
    ...
    public virtual ICollection<AuditoresDisposicionesTran> AuditoresDisposicionesTrans { get; set; } = new List<AuditoresDisposicionesTran>();
}
