...
public partial class ProfesionalesDisposicionesTran
{
    ...
    public virtual ICollection<ProfesionalesDisposicionesHistorico> ProfesionalesDisposicionesHistoricos { get; set; } = new List<ProfesionalesDisposicionesHistorico>();
}
