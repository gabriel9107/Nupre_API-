...
public partial class PromotoresPromotorasRequerimientosTran
{
    ...
    public virtual PromotoresPromotorasMaster PromotoraRncNavigation { get; set; } = null!;

    public virtual PromotoresRequerimientosEstadosCatum RequerimientoEstadoNumeroNavigation { get; set; } = null!;
}
