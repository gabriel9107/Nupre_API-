...
public partial class ProfesionalesPreguntasCatum
{
    /// <summary>
    ...
    public virtual ICollection<ProfesionalesPreguntasHistorico> ProfesionalesPreguntasHistoricos { get; set; } = new List<ProfesionalesPreguntasHistorico>();

    public virtual ICollection<ProfesionalesPreguntasRespuestasCatum> ProfesionalesPreguntasRespuestasCata { get; set; } = new List<ProfesionalesPreguntasRespuestasCatum>();
}
