...
/// <summary>
/// Es un catálogo que contiene las versiones de los formulario de visitas (grupo de preguntas definidos para un tipo de PSS), su fuente de datos son los sistemas internos de la SISALRIL.
/// </summary>
public partial class IndicadoresPssTipoVersionesCatum
{
    /// <summary>
    ...
    public virtual IndicadoresPssTipoVersionesEstadoCatum IndicadorVersionEstadoNumeroNavigation { get; set; } = null!;
}
