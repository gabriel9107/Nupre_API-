...
/// <summary>
/// Es un maestro donde se registran los detalles de los traspasos recibidos desde UNIPAGO y los datos sobre los procesos que se realizan con ellos, su fuente de datos la vista de traspasos publicadas por UNIPAGO y los sistemas internos de la SISALRIL.
/// </summary>
public partial class TraspasosMaster
{
    /// <summary>
    ...
    public virtual ArsMaster ArsDestinoNavigation { get; set; } = null!;

    public virtual ArsMaster ArsOrigenNavigation { get; set; } = null!;

    public virtual TraspasosEstadosCatum NuctEstadoNumeroNavigation { get; set; } = null!;
    ...
    public virtual TraspasosVecimientosTipoCatum TraspasoVencimientoTipoNumeroNavigation { get; set; } = null!;

    public virtual ICollection<TraspasosErroresTran> TraspasosErroresTrans { get; set; } = new List<TraspasosErroresTran>();
    ...
    public virtual ICollection<TraspasosHistorico> TraspasosHistoricos { get; set; } = new List<TraspasosHistorico>();
    ...
    public virtual ICollection<TraspasosSolicitudesImagenesUnipagoTran> TraspasosSolicitudesImagenesUnipagoTrans { get; set; } = new List<TraspasosSolicitudesImagenesUnipagoTran>();
}
