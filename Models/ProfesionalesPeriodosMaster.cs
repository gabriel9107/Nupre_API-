...
public partial class ProfesionalesPeriodosMaster
{
    /// <summary>
    ...
    public virtual ICollection<ProfesionalesPeriodosHistorico> ProfesionalesPeriodosHistoricos { get; set; } = new List<ProfesionalesPeriodosHistorico>();
}
