...
public partial class ProfesionalesEspecialidadesTran
{
    ...
    public virtual ICollection<ProfesionalesEspecialidadesHistorico> ProfesionalesEspecialidadesHistoricos { get; set; } = new List<ProfesionalesEspecialidadesHistorico>();
}
