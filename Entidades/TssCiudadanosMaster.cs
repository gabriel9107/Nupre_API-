...
public partial class TssCiudadanosMaster
{
    ...
    //public virtual AcreditacionesPersonasMaster? AcreditacionesPersonasMaster { get; set; }

    //public virtual ICollection<AfiliadosPlanesComplementariosTran> AfiliadosPlanesComplementariosTranAfiliadoNssNavigations { get; set; } = new List<AfiliadosPlanesComplementariosTran>();

    //public virtual ICollection<AfiliadosPlanesComplementariosTran> AfiliadosPlanesComplementariosTranAfiliadoTitularNssNavigations { get; set; } = new List<AfiliadosPlanesComplementariosTran>();

    //public virtual AfiliadosSfsMaster? AfiliadosSfsMasterAfiliadoNssNavigation { get; set; }

    //public virtual ICollection<AfiliadosSfsMaster> AfiliadosSfsMasterAfiliadoTitularNssNavigations { get; set; } = new List<AfiliadosSfsMaster>();
    ...
    //public virtual ICollection<TssTrabajadoresTran> TssTrabajadoresTrans { get; set; } = new List<TssTrabajadoresTran>();
}
